...
function Header() {
    ...
    const linkClass = (id)=>`relative transition ${active === id ? "font-semibold text-purple-600 after:absolute after:left-0 after:-bottom-1 after:w-full after:h-[2px] after:bg-purple-600" : "text-black"}`;
...
_s(Header, "nsi49W4P9ILLRfNSWb6GdpPWwCw=");
_c = Header;
var _c;
...
//# sourceMappingURL=_5295bf3d._.js.map